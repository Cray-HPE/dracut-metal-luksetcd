...
%define url_dracut_doc /usr/share/doc/dracut-metal-luksetcd/
...
%{__install} -m 0755 metal-luksetcd-disk.sh module-setup.sh metal-update-fstab.sh metal-update-keystore.sh parse-metal-luksetcd.sh metal-luksetcd-lib.sh metal-luksetcd-genrules.sh %{buildroot}%{dracut_modules}/98metalluksetcd
